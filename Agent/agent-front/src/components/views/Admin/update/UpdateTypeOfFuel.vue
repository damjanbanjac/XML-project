      ...
      <div class="card" style="width: 40%">
        ...
        <div class="header pt-3 grey lighten-2">
          <div class="row d-flex justify-content-start">
            ...
            font-weight: 300;
            line-height: 1.2;
            margin-top: -12%;">Update type of fuel</h3>
          </div>
        </div>
        <!--Header-->
 ...
 export default {
    ...
    methods: {
      ...
      cancelClick() {
        ...
        this.change = false;
        axios
        .get("/fuel-types/" + this.$route.params.id + "/fuel-type")
        .then(type => {
          this.form = type.data;
        })
        .catch(error => {
      ...
      saveClick() {
        ...
        axios
        .put("/fuel-types/" + this.$route.params.id + "/fuel-type", this.form)
        .then(type => {
        this.form = type.data;
        this.change = false;
        this.success = true;
        this.successmessage = "You have successfully updated a fuel type."
        })
        .catch(error => {
          console.log(error);
        });
