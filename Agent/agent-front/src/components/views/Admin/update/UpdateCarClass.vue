      ...
      <div class="card" style="width: 40%">
        ...
        <div class="header pt-3 grey lighten-2">
          <div class="row d-flex justify-content-start">
            ...
            font-weight: 300;
            line-height: 1.2;
            margin-top: -12%;">Update car class</h3>
          </div>
        </div>
        <!--Header-->
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="md-form pb-3">
                  ...
                  <input type="text" id="Form-car_class" class="form-control" v-model="form.car_class" :disabled="!change" />
 ...
 export default {
    ...
    methods: {
        ...
        cancelClick() {
          ...
          this.change = false;
          axios
          .get("/classes/" + this.$route.params.id + "/class")
          .then(class1 => {
        ...
        saveClick() {
          ...
          axios
          .put("/classes/" + this.$route.params.id + "/class", this.form)
          .then(class1 => {
          this.form = class1.data;
          this.change = false;
          this.success = true;
          this.successmessage = "You have successfully updated a car class."
          })
          .catch(error => {
            console.log(error);
          });
