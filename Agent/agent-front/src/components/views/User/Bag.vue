          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="md-form">
                ...
                <input type="date" id="Form-availableTo" class="form-control" v-model="oglas.availableFrom" :disabled="!change" >
            ...
            <div class="col">
              <div class="md-form pb-3">
                ...
                <label id="Form-ime" class="form-control">{{oglas.adCar.agentAd.id}}</label>

                <div class="md-form">
                <label for="Form-ime">End data:</label>
                <input type="date" id="Form-availableTo" class="form-control" v-model="oglas.availableTo" :disabled="!change" >
                <br/>
