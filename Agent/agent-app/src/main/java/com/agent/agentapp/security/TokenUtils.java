package com.agent.agentapp.security;

import com.agent.agentapp.common.TimeProvider;
...
public class TokenUtils {
   ...
   // String base64Key = Encoders.BASE64.encode(key.getEncoded());
    ...
    public String generateToken(SimpleUser user, Authority role) {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        SimpleUser user = (SimpleUser) userDetails;
