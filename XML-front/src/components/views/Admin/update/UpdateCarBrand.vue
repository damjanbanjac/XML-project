      ...
      <div class="card" style="width: 40%">
        ...
        <div class="header pt-3 grey lighten-2">
          <div class="row d-flex justify-content-start">
            ...
            font-weight: 300;
            line-height: 1.2;
            margin-top: -12%;">Update car brand</h3>
          </div>
        </div>
        <!--Header-->
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="md-form pb-3">
                  ...
                  <input type="text" id="Form-name" class="form-control" v-model="form.name" :disabled="!change" />

                  <label for="Form-label">Label</label>
                  <input type="text" id="Form-label" class="form-control" v-model="form.label" :disabled="!change" />
 ...
 export default {
    ...
    methods: {
        ...
        cancelClick() {
          ...
          this.change = false;
          axios
          .get("/maintenance/brands/" + this.$route.params.id + "/brand")
          .then(brand => {
        ...
        saveClick() {
          ...
          axios
          .put("/maintenance/brands/" + this.$route.params.id + "/brand", this.form)
          .then(brand => {
          this.form = brand.data;
          this.change = false;
          this.success = true;
          this.successmessage = "You have successfully updated a car brand."
          })
          .catch(error => {
            console.log(error);
          });
